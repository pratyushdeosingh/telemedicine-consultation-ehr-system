...
The DA2 evidence and supporting scripts are:
...
- `telemedicine_session_trigger.sql`: creates a telemedicine session automatically when a new Virtual appointment is inserted.
